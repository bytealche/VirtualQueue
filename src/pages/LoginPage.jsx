...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        if (formData.userType === 'provider' || result.user?.userType === 'provider') {
        ...
        <div className="glass-card p-8 glow-hover">
          ...
          <div className="flex glass-card p-1 mb-6">
            <button
              ...
              style={{
                background: formData.userType === 'customer' ? 'linear-gradient(135deg, #24FB94 0%, #13C0BD 100%)' : 'transparent',
                fontWeight: 300
              }}
            >
              Customer
            ...
            <button
              ...
              style={{
                background: formData.userType === 'provider' ? 'linear-gradient(135deg, #24FB94 0%, #13C0BD 100%)' : 'transparent',
                fontWeight: 300
              }}
            >
              Provider
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-text-secondary font-light">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-sm text-accent-green hover:text-accent-cyan transition-colors font-light">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-secondary text-text-secondary font-light">Don't have an account?</span>
            </div>
          </div>

          <Link to="/register" className="block w-full btn-outline py-3 text-center text-lg font-light">
            Create Account
          </Link>
