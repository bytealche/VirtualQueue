...
const HomePage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Get notified when your turn approaches via SMS, Email or App'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-primary text-text-primary relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
               <a href="#features" className="text-text-secondary hover:text-white transition-colors font-light nav-link">
                FEATURES
              </a>
              <a href="#how-it-works" className="text-text-secondary hover:text-white transition-colors font-light nav-link">
                HOW IT WORKS
              </a>
              <a href="#services" className="text-text-secondary hover:text-white transition-colors font-light nav-link">
                SERVICES
              </a>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute right-0.5 top-0 left-0 w-10/2 opacity-90 pointer-events-none">
          <img src="/div.png" alt="" className="w-screen h-auto" />
        </div>
            ...
            <div className="fade-in">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white font-light">1000+ Active Users</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-white flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-white font-light">500+ Service Providers</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-white flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-white font-light">50K+ Queues Managed</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-white flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-white font-light">95% Customer Satisfaction</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="how-it-works" className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              { num: '1', title: 'Choose Service', desc: 'Select from banking, healthcare, government services or retail' },
              { num: '2', title: 'Book Your Slot', desc: 'Reserve your position in the virtual queue. Choose date, time and notifications' },
              { num: '3', title: 'Get Notified', desc: 'Receive real-time updates and notifications when it\'s your turn. Arrive just in time!' }
            ].map((step, index) => (
              <div key={index} className="text-center fade-in" style={{ animationDelay: `${index * 0.2}s` }}>
                ...
                <h3 className="text-2xl font-light mb-4 text-white">{step.title}</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-text-secondary font-light">{service.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="glass-card p-6 glow-hover">
                ...
                <p className="text-text-secondary mb-4 leading-relaxed font-light">"{testimonial.text}"</p>
                <div>
                  <div className="font-light text-white">{testimonial.name}</div>
                  <div className="text-sm text-text-secondary font-light">{testimonial.role}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="relative py-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h3 className="font-light mb-4 text-lg text-white">Quick Links</h3>
              <ul className="space-y-2 text-sm">
                <li><a href="#features" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Features</a></li>
                <li><a href="#how-it-works" className="text-text-secondary hover:text-white transition-colors font-light footer-link">How It Works</a></li>
                <li><a href="#services" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Services</a></li>
                <li><Link to="/login" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Login</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-light mb-4 text-lg text-white">Support</h3>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Help Center</a></li>
                <li><a href="#" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Contact Us</a></li>
                <li><a href="#" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Privacy Policy</a></li>
                <li><a href="#" className="text-text-secondary hover:text-white transition-colors font-light footer-link">Terms of Service</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-light mb-4 text-lg text-white">Connect</h3>
              <div className="flex space-x-4">
                <a href="#" className="text-text-secondary hover:text-white transition-colors footer-link">
          ...
          <div className="border-t border-white border-opacity-10 pt-8 text-center text-sm text-text-secondary">
            <p className="font-light">&copy; 2024 QueMe. All rights reserved. | Developed for Educational Purposes</p>
          </div>
        </div>
      </footer>
