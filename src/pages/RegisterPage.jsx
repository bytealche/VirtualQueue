  ...
  return (
    <div className="min-h-screen bg-primary flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl" style={{background: 'linear-gradient(135deg, #24FB94 0%, #13C0BD 100%)'}}></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl" style={{background: 'linear-gradient(135deg, #13C0BD 0%, #24FB94 100%)'}}></div>
      </div>
      ...
      <div className="w-full max-w-2xl relative z-10">
        <div className="glass-card p-8 glow-hover">
          ...
          <h2 className="text-3xl text-center mb-2" style={{fontWeight: 200}}>Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm mb-2" style={{fontWeight: 300}}>Full Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm mb-2" style={{fontWeight: 300}}>Phone Number</label>
                <input
                  type="tel"
                  name="phone"
            ...
            <div>
              <label className="block text-sm mb-2" style={{fontWeight: 300}}>Email Address</label>
              <input
                type="email"
                name="email"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm mb-2" style={{fontWeight: 300}}>Password</label>
                <input
                  type="password"
                  name="password"
              ...
              <div>
                <label className="block text-sm mb-2" style={{fontWeight: 300}}>Confirm Password</label>
                <input
                  type="password"
            ...
            {userType === 'provider' && (
              <>
                <div className="border-t border-gray-800 pt-6">
                  <h3 className="text-xl mb-4" style={{fontWeight: 200}}>Business Information</h3>
                  
                  <div className="space-y-6">
                    <div>
                      <label className="block text-sm mb-2" style={{fontWeight: 300}}>Business Name</label>
                      <input
                        type="text"
                        name="businessName"
                    ...
                    <div>
                      <label className="block text-sm mb-2" style={{fontWeight: 300}}>Business Type</label>
                      <select
                        name="businessType"
                    ...
                    <div>
                      <label className="block text-sm mb-2" style={{fontWeight: 300}}>Business Address</label>
                      <textarea
                        name="address"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-secondary text-text-secondary" style={{fontWeight: 300}}>Already have an account?</span>
            </div>
          </div>
